...
public class DBService {
    ...
    public void initDB(){
        ...
        Client client2 = new Client( 2, "lewis.hamilton@gmail.com","123-321-456-10","Lewis",encoder.encode("123"), animal2);

        Employee employee1 = new Employee(3, "leila.pereira@gmail.com", "122-321-456-12", "Leila Pereira", encoder.encode("123"));
